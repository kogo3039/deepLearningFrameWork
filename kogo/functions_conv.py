import numpy as np
from kogo import cuda
from kogo.core import Function, as_variable
from kogo.utils import pair, get_conv_outsize, get_deconv_outsize
from kogo.functions import linear, broadcast_to
